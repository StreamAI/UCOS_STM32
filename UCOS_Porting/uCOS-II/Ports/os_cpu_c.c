...
//	RCC_GetClocksFreq(&rcc_clocks);		//获得系统时钟
//	SysTick_Config(rcc_clocks.HCLK_Frequency/OS_TICKS_PER_SEC);	//初始化并使能SYSTICK定时器，HCLK_Frequency是由系统时钟SYSCLK_Frequency分频后得到的AHB总线时钟
//}
